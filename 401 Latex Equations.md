Gauss's Law: $\displaystyle \oint\vec{E}\cdot\text{d}\vec{A} = \dfrac{Q_{in}}{\varepsilon_0}$, $\nabla\cdot\vec{E} = \dfrac{\rho}{\varepsilon_0}$

Faraday's Law: $\displaystyle \oint\vec{E}\cdot\text{d}\vec{s} = -\dfrac{\text{d}\Phi_m}{\text{d}t}$, $\nabla \times \vec{E} = -\dfrac{\partial\vec{B}}{\partial t}$

Ampere-Maxwell: $\displaystyle \oint\vec{B}\cdot\text{d}\vec{s} = \mu_0I_{ext} + \varepsilon_0\mu_0\dfrac{\text{d}\Phi_e}{\text{d}t}$

Charge Continuity: $\displaystyle \frac{\partial\rho}{\partial t} = -\nabla\cdot\vec{J}$

Energy Density: $\displaystyle u = \frac{\varepsilon_0}{2}E^2 + \frac{1}{2\mu_0}B^2$
...
Momentum Density of EM Field: $\displaystyle \vec{g} = \varepsilon_0\mu_0\vec{S} = \frac{\text{d}\vec{P}_{\text{EM}}}{\text{d}\tau}$
